    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-blue-900 text-white p-5 space-y-6">
        ...
        {!isAdmin || !showAdminDashboard ? (
          ...
          <>
            ...
            <nav className="flex flex-col space-y-4">
              ...
              <NavLink to="all-messages" className={linkClasses}>
                <FaEnvelope />
        ...
        <NavLink
          ...
          className="flex items-center space-x-2 p-3 hover:bg-red-500 text-white rounded-lg"
        >
          <FaSignOutAlt />
          <span>Logout</span>
        </NavLink>
      ...
      <button
        onClick={toggleDrawer}
        className="md:hidden fixed top-4 left-4 bg-blue-900 text-white p-3 rounded-full"
      >
        <FaBars />
      </button>
    </div>
